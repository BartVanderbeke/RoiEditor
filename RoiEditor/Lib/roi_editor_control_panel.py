...
from file_choosers import find_related_filenames
...
from event_eater_overlay import EventEaterOverlay
...
class RoiEditorControlPanel(QMainWindow):
    ...
    def __init__(self,parent):
        ...
        uifile = os.path.join(basepath, "roi_editor_control_panel.ui")
