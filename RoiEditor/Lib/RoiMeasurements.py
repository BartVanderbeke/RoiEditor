...
if __name__ == "__main__":
    ...
    print(" ".join([f"{v:.3f}".rjust(8) for k, v in stats_all_area.items() if k not in ["hist", "bin_edges","outliers"]]))
    ...
    print(" ".join([f"{v:.3f}".rjust(8) for k, v in stats_del.items() if k not in ["hist", "bin_edges","outliers"]]))
